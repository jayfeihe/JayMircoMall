# QuickStart
基于SpringCloud的微服务架构实战案例项目，以一个简单的购物流程为示例，融合zipkin,eureka,feign,rabbion,JWT,hystrix,zuul,swagger等
...
# 快速上手
- 0、启动redis和rabbitMQ服务  
     1.redis启动
       不带密码启动
       docker run --name picker-redis -p 6379:6379 -d redis
